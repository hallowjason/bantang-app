  ...
  return (
    <div className="min-h-screen bg-cream flex flex-col items-center justify-center px-6">
      ...
      <div className="flex flex-col items-center gap-3 mb-8">
        <h1 className="text-xl font-semibold text-ink">班員入口</h1>
      ...
      {/* 登入卡片 */}
      <div className="card-lovable w-full max-w-xs flex flex-col gap-4">
        <button
          onClick={handleLogin}
      ...
      <Link
        to="/portal/schedule"
        className="mt-6 text-xs text-muted hover:text-ink hover:underline transition-colors"
      >
        ← 不登入，直接進入班員入口
      </Link>
    </div>
