...
| `head_leader`（大領班） | 可查看**所有班級**的資料與匯出報表；底部導覽額外增加第 4 個「總覽」Tab |
...
// ─── 使用者角色 ───────────────────────────────────────────
export type UserRole = 'leader' | 'head_leader'
